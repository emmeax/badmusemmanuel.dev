...
const Contact = () => {
  return (
    <div className='bg-black text-white py-' id="contact">
        <div  className='container mx-auto px-8 md:px-10 lg:px-10'>
            ...
            <div className='flex flex-col ma:flew-row item-center md:space-x-12'> 
              <div className='flex-1'>
                ...
                <p>I'm open for a Front-end web development job opportunities</p>
                ...
                <div className='mb-4 mt-8'>
                  ...
                  <span>+2349017698728</span>
                </div>
                <div className='mb-4 mt-8'>
                  <FaWhatsapp className="inline-block text-green-400 mr-2" ></FaWhatsapp>
                  <span>+2349017698728</span>
                </div>
                <div className='mb-4 mt-8'>
